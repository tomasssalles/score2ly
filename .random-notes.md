...
- Document future work item in README: Handle scores with multiple movements (MusicXML produces multiple outputs named input_name.mvtN.xml, see e.g. cello_suite-leipzig.pdf)
- Document future work item in README: GUI
