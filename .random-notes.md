...
### Logging
- Lots of logs refer to bundle files just by name, others even include the bundle directory name. Make all such paths relative to the bundle directory (e.g. not "book.omr" or "fuer_elise.s2l/03.audiveris_omr/book.omr" but "03.audiveris_omr/book.omr").
