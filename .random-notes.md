...
4. Release v0.1.0 and move on to phase 2! (Don't you dare start working on the GUI!)
...
- Maybe fallback to asking the LLM to generate the LilyPond without a starting point if a .ly snippet couldn't be generated. For the Kinderscenen sample score, even with manual cropping and deskewing, OMR got the system bounding boxes perfect but the MusicXML was a disaster and the number of measures didn't match the reality.
