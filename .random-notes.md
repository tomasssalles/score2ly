...
- Bugfix: In score2ly.pipeline._collect_score_info, if the user sets --no-prompt and passes some score info args with "-", they will not be converted into "". Make sure they do, but maintain the fallback logic to extracted values, and make sure they're still marked as confirmed.
